...
always @(sel) begin: CPLD2_DEC_DECODER
    sel_decoded[0] = ((!sel[0]) && (!sel[1]) && (!sel[2]));
    sel_decoded[1] = (sel[0] && (!sel[1]) && (!sel[2]));
    sel_decoded[2] = ((!sel[0]) && sel[1] && (!sel[2]));
    sel_decoded[3] = (sel[0] && sel[1] && (!sel[2]));
    sel_decoded[4] = ((!sel[0]) && (!sel[1]) && sel[2]);
end
